...
class DefaultUserInputWithStandardFields(userInputData: UserInputData = UserInputDataImpl(), keyPrefix: String) : DefaultUserInput by DefaultUserInputImpl(userInputData),
