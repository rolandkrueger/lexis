...
/**
 * Interface for defining the vocabulary input for one particular language. A [UserInput] is associated with exactly
 ...
 *
 *  A [UserInput] allows to store three types of data:
 *
 ...
 *  * Textual configuration values: Any String that is not directly entered by the user and needs to be stored in a [UserInput]
...
interface UserInput {
     ...
     *
     * A configuration value can be arbitrary data which is fully under control of the [UserInput] that sets it.
